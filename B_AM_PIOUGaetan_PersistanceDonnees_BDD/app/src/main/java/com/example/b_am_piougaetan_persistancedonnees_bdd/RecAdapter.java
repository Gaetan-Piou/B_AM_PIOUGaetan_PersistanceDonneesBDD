...
public class RecAdapter extends RecyclerView.Adapter<RecAdapter.ViewHolder> {
    private ArrayList<com.example.cornuluc_persistance_bdd_mysql.User> userList;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            Username= (TextView) v.findViewById(R.id.textview_List_Userna);
    ...
    public RecAdapter(ArrayList<com.example.cornuluc_persistance_bdd_mysql.User> userList) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final com.example.cornuluc_persistance_bdd_mysql.User users = userList.get(position);
