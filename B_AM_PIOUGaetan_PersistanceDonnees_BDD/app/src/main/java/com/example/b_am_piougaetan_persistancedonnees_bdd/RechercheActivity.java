package com.example.b_am_piougaetan_persistancedonnees_bdd;
                    ...
                    public void onResponse(String response)
                    {
                        ...
                        try {
                            ...
                            if (!jsonObject.getBoolean("error"))
                            {
                                ...
                                ArrayList<com.example.cornuluc_persistance_bdd_mysql.User> userList = new ArrayList<com.example.cornuluc_persistance_bdd_mysql.User>();

                                for (int i = 0; i < ResultArray.length(); i++)
                                {
                                    JSONObject object = ResultArray.getJSONObject(i);
                                    com.example.cornuluc_persistance_bdd_mysql.User user = new com.example.cornuluc_persistance_bdd_mysql.User(object.getString("USERNAME"), object.getString("EMAIL"), object.getString("LOCALITE"));
                                    userList.add(user);
                                }
